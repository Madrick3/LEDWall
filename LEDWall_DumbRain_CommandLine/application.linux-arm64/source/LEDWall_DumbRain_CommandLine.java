...
public class LEDWall_DumbRain_CommandLine extends PApplet {
...
public void settings() {
  //String[] args = new String[]{"--image-width", "400", "--image-height", "300", "--num-panels-x", "1", "--num-panels-y", "1", "--screen-saver", "2", "--canvas-width", "800", "--canvas-height", "800", "--image-filename", "testing.jpg"};
...
public void draw() {
   if (testObserver.hasStrips || !sendToPanels) { //scrape for the strips and determine if we can send to the pixelpusher
     ...
     } else { //if(screenSaver == 1){ // doing a screensaver of some time
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "LEDWall_DumbRain_CommandLine" };
    if (passedArgs != null) {
